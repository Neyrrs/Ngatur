  ...
  const Page = () => {
    ...
    return (
      <div className="w-full h-full flex md:flex-row flex-col md:pl-15 md:gap-10">
        <div className="h-full px-15 md:px-0 py-5 md:w-2/3 w-full text-foreground overflow-y-scroll flex flex-col gap-5">
          ...
          {/* <div className="flex p-5 w-full min-h-80 rounded-md border-2 border-primary" /> */}
        </div>

        <div className="bg-secondary w-full md:w-1/3 p-5 flex flex-col h-fit md:h-full gap-5 text-foreground">
