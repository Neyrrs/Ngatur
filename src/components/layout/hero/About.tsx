...
const About = () => {
  return (
    <div>
      ...
      <div className="h-fit w-screen items-center flex justify-between gap-10 px-15 bg-[#222831]">
        <div className="flex flex-col text-white gap-5 md:gap-10 w-full h-full">
          <h1 className="md:text-6xl text-3xl font-semibold">
            What is Ngatur all about?
          </h1>
          <p className="w-3/4 text-sm md:text-lg">
